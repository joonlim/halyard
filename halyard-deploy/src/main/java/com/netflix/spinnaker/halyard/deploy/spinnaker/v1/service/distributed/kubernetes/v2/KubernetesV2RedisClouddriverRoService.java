...
@Component
public class KubernetesV2RedisClouddriverRoService extends RedisService implements KubernetesV2Service<Jedis> {
  @Delegate
  @Autowired
  ...
  @Override
  public String getRole() { return "clouddriver-ro"; }
}
