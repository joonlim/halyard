...
public class KubernetesV2FiatService extends FiatService implements KubernetesV2Service<FiatService.Fiat> {
  ...
  public static class FiatServiceBuilder extends SpringService.Builder<KubernetesV2FiatService,FiatServiceBuilder> {
    KubernetesV2FiatService source;

    public FiatServiceBuilder(KubernetesV2FiatService source) {
    ...
    public KubernetesV2FiatService build() {
      Type type = Type.FIAT.withNameSuffix(typeNameSuffix);
