...
public class KubernetesV2RoscoService extends RoscoService implements KubernetesV2Service<RoscoService.Rosco> {
  ...
  public static class RoscoServiceBuilder extends SpringService.Builder<KubernetesV2RoscoService,RoscoServiceBuilder> {
    KubernetesV2RoscoService source;

    public RoscoServiceBuilder(KubernetesV2RoscoService source) {
    ...
    public KubernetesV2RoscoService build() {
      Type type = Type.ROSCO.withNameSuffix(typeNameSuffix);
