...
public class KubernetesV2GateService extends GateService implements KubernetesV2Service<GateService.Gate> {
  ...
  public static class GateServiceBuilder extends SpringService.Builder<KubernetesV2GateService,GateServiceBuilder> {
    KubernetesV2GateService source;

    public GateServiceBuilder(KubernetesV2GateService source) {
    ...
    public KubernetesV2GateService build() {
      Type type = Type.GATE.withNameSuffix(typeNameSuffix);
