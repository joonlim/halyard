...
public class KubernetesV2IgorService extends IgorService implements KubernetesV2Service<IgorService.Igor> {
  ...
  public static class IgorServiceBuilder extends SpringService.Builder<KubernetesV2IgorService,IgorServiceBuilder> {
    KubernetesV2IgorService source;

    public IgorServiceBuilder(KubernetesV2IgorService source) {
    ...
    public KubernetesV2IgorService build() {
      Type type = Type.IGOR.withNameSuffix(typeNameSuffix);
