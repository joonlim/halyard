...
@Component
public class KubernetesV2ClouddriverCachingService extends AbstractKubernetesV2ClouddriverService{
  @Autowired
  ...
  public ServiceSettings defaultServiceSettings(DeploymentConfiguration deploymentConfiguration) {
    ...
    profiles.add("caching");
    profiles.add("caching-test");
    profiles.add("caching-local");
